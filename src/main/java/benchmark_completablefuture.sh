...
REPEATS=5
CSV_FILE="benchmark_completablefuture_full_dataset_3_no_gc_tunning2.csv"
JAVA_OPTS="-Xms512m -Xmx512m"
CLASS="CompletableFuture.CompletableFutureApproach"

# Compile the program
javac CompletableFuture/CompletableFutureApproach.java || { echo "Compilation failed"; exit 1; }
