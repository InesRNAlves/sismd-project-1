...
REPEATS=5
CSV_FILE="benchmark_forkjoinpool_full_dataset_3_no_gc_tunning.csv"
JAVA_OPTS="-Xms512m -Xmx512m"
CLASS="ForkJoinPool.ForkJoinPoolApproach"

# Compile the program
javac ForkJoinPool/ForkJoinPoolApproach.java || { echo "Compilation failed"; exit 1; }
