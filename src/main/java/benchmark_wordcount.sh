...
REPEATS=5
CSV_FILE="benchmark_wordcount_full_dataset_3_no_gc_tunning.csv"
CLASS="StarterCode.WordCount"

# Compile the program
javac StarterCode/WordCount.java || { echo "Compilation failed"; exit 1; }
